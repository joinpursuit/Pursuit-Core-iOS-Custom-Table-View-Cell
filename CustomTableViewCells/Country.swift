...
struct Country {
    ...
    static let countries = [
        ...
        Country(name: "Ecuador 🇪🇨",
                description: "City in Southern Ecuador. Known for hand crafted Panama hats :womans_hat:(and other things I can't remember...)",
                continent: "South America"),
        ...
        Country(name: "Dominica 🇩🇲",
                description: "Dominica is a small island in the West Indies with a population of just under 75,000 people. One of it's national dances is the the Bele, a dance that displays it's national wear.",
                continent: "North America"),
        Country(name: "Mexico 🇲🇽",
